...
@observer
export default class LineChartCusotmizationModal extends React.Component<CustomizationProps, CustomizationState>{
    ...
    componentDidUpdate = (prevProps: CustomizationProps, prevState: CustomizationState) => {
        if (prevState.scatterParams !== wikiStore.ui.scatterGroupingParams) {
            ...
            this.setState({
                color: wikiStore.ui.linechartGroupingParams.color,
                markerSymbol: wikiStore.ui.linechartGroupingParams.markerSymbol,
                markerSize: wikiStore.ui.linechartGroupingParams.markerSize,
                scatterParams: wikiStore.ui.linechartGroupingParams,
                colorLevel: wikiStore.ui.linechartGroupingParams.colorLevel
            });
        ...
        if (prevState.color !== this.state.color ||
            ...
            this.props.onParamsChanged(wikiStore.ui.linechartGroupingParams);
    ...
    handleColorChange = (selected: SelectOption) => {
        ...
        wikiStore.ui.linechartGroupingParams.color = column;
        this.setState({
            color: column,
        });
    }
    ...
    handleMarkerSymbolChange = (selected: SelectOption) => {
        ...
        wikiStore.ui.linechartGroupingParams.markerSymbol = column;
        this.setState({
            markerSymbol: column,
        });
    }
    ...
    handleLineStyleChange = (selected: SelectOption) => {
        ...
        wikiStore.ui.linechartGroupingParams.markerSize = column;
        this.setState({
            markerSize: column,
        });
    }
    ...
    handleColorLevelChange= (selected: SelectOption) => {
        ...
        wikiStore.ui.linechartGroupingParams.colorLevel = column;
        this.setState({
            colorLevel: column,
        });
    }
    ...
    render = () => {
        console.debug('linechart customization modal color grouping: ', wikiStore.ui.linechartGroupingParams.color?.name ?? 'undefined');
